...
function getSelected() {
    ...
    //we write answerEl from ourselfs
...
//if we select an answer then submit button the answer from the previous question is still shown--with deselectAnswer() we prevent that 
...
submitBtn.addEventListener("click", () => {
    ...
    if (answer) {
        ...
        //go to the next question--currentQuize is a question that we are in
        currentQuiz++;
